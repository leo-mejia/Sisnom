document.getElementById('loginForm').addEventListener('submit', function (e) {
      ...
      if (email === 'admin@sisnom.com' && password === '1234') {
        ...
        window.location.href = '/Administrador/administrador.html'; // redirige a la página del administrador
      } else if (email === 'empleado@sisnom.com' && password === '1234') {
        alert('Bienvenido empleado 👋');
        window.location.href = '/empleado/empleado.html'; // redirige a la página del empleado
      } else {
